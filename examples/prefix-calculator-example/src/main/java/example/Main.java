...
/**
 * This program is a prefix calculator that reads input from standard input.
 *
...
final class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Usage: Enter a prefix expression to evaluate or 'exit' to exit.");
