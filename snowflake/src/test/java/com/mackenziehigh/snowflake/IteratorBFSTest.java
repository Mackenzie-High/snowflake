...
public final class IteratorBFSTest 
{
     ...
     */
    @Test
    public void test20130203173802103928()
    {
        System.out.println("Test: 20130203173802103928");
        ...
        final Iterator<ITreeNode> iter = root.iterableBFS().iterator();
     ...
     */
    @Test
    public void test20130203173802104038()
    {
        System.out.println("Test: 20130203173802104038");
    ...
    public void test20130203173802104087()
    {
        System.out.println("Test: 20130203173802104087");
        
        final TreeNode node = new TreeNode();
        
        node.initialize(new RuleString("xoo"), "abcdefghi".toCharArray(), 2, 1);
        
        final Iterator<ITreeNode> iter = node.iterableBFS().iterator();
