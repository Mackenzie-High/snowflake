...
public enum NewlineStyles
{
     ...
     *
     * @param input is the input that will be parsed.
     * @param expected is the default new line style.
     * @return the newline style that is present in the input.
     * If no newline style is detected in the input, then return the expected newline style.
     */
    public static NewlineStyles fromGuess(final String input,
                                          final NewlineStyles expected)
    {
