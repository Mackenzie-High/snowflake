 ...
 */
package com.mackenziehigh.snowflake.portfolio;
...
//        output.set("visitor", "");
    ...
    {
        final List<Json> children = new ArrayList<>(node.childCount());
    ...
    {
        final String grammar = Files.readString(grammarFile.toPath());
        final String input = Files.readString(inputFile.toPath());
...
//        args[3] = "/home/mackenzie/Code/snowflake/example/output.txt";
        ...
        {
            final File grammarFile = new File(args[1]);
