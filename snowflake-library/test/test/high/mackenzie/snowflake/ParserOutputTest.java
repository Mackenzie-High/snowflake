...
public final class ParserOutputTest
{
    ...
    /**
     * Test: 20130525105951145657
     *
     * <p>
     * Method:
     * <code>print(PrintStream, boolean, boolean, boolean)</code>
     * </p>
     *
     * <p>
     * Case: throughput
     ...
     */
    @Test
    public void test20130525105951145657()
    {
        System.out.println("Test: 20130525105951145657");
        ...
        po.print(stream, true, true, true);
     ...
     */
    @Test
    public void test20130828162955246585()
            throws ParsingFailedException
    {
        System.out.println("Test: 20130828162955246585");

        final char[] input = new char[0];

        final ITreeNode parse_tree = new TreeNode();

        final Tracer tracer = new Tracer(8);

        final int farthest_position = 0;
    ...
    /**
     * Test: 20130828162955246707
     *
     * <p>
     * Method:
     * <code>requireSuccess()</code>
     * </p>
     *
     * <p>
     * Case: failure
     ...
     */
    @Test
    public void test20130828162955246707()
            throws ParsingFailedException
    {
        System.out.println("Test: 20130828162955246707");

        final char[] input = new char[0];

        final ITreeNode parse_tree = null;
        ...
        {
            assertTrue(ex.parserOutput() == output);
            return;
        }
