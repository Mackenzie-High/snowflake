...
public enum NewlineStyles 
{
     ...
     * 
     * <p>
     * If this style is the <code>UNSUPPORTED</code> style, then an empty string is returned. 
     * </p>
     * 
     ...
     * 
     * <p>The <code>UNSUPPORTED</code> style is returned, if the newline is unrecognized.</p>
     * 
    ...
    public static NewlineStyles fromNewline(final String newline)
    {
        ...
        for(NewlineStyles style : NewlineStyles.values()) { styles.put(style.newline(), style); }
     ...
     * 
     * <p>The platform newline is found using <code>System.getProperty("line.separator").</code></p>
     * 
     * <p>The <code>UNSUPPORTED</code> style is returned, if the newline is unrecognized.</p>
     * 
