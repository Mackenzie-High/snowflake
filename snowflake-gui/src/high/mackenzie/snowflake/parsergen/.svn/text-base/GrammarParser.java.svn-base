...
public final class GrammarParser implements IParser
{
    ...
    private static Grammar grammar()
    {
        ...
        g.choose("directive", "directive_root", "directive_trace", "directive_package", "directive_parser", "directive_visitor");
        ...
        g.str("character_maximum", "MAX");
        g.str("character_minimum", "MIN");
