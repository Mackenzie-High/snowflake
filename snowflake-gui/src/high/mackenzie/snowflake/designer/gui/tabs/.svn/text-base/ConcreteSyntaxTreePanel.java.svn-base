 ...
 * @author mackenzie
 */
public class ConcreteSyntaxTreePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(high.mackenzie.snowflake.designer.gui.SnowflakeIDEApp.class).getContext().getResourceMap(ConcreteSyntaxTreePanel.class);
    ...
    private void jTree1ValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_jTree1ValueChanged
       ...
       if(obj instanceof DisplayableTreeNode)
       {
           ...
           jTextArea1.setText(((DisplayableTreeNode) obj).getMatchText());
       }
       else
       {
    ...
    public JTree getParseTree() { return jTree1; }
